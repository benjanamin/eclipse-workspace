...
import 1.handlers.OpenHandler;
import 1.model.Media;
import 1.model.MediaType;
	...
	static class MediaCell extends ListCell<Media> {
		...
		protected void updateItem(Media item, boolean empty) {
			if(  ! empty && item != null ) {
				...
				switch (item.getType()) {
				case MOVIE:
					setGraphic(new ImageView("platform:/plugin/1/icons/kaffeine.png"));
					break;
				case PICTURE:
					setGraphic(new ImageView("platform:/plugin/1/icons/games-config-background.png"));
					break;
				default:
					setGraphic(new ImageView("platform:/plugin/1/icons/player-volume.png"));
					break;
				}				
			}
