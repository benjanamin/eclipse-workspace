...
public class Queso extends Lacteos {
	String Estado;
	...
	public Queso(String nombre,int cantidad,String precio,String marca,String estado,String fechaF,String fechaV, String sku) {
