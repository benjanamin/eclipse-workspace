...
public class Naranja extends Frutas {
	String Estado;
	...
	public Naranja(String nombre,int cantidad,String precio,String marca,String estado,String fechaF,String fechaV, String sku) {
