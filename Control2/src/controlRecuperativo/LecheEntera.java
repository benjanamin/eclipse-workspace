...
public class LecheEntera extends Lacteos {
	String Estado;
	...
	public LecheEntera(String nombre,int cantidad,String precio,String marca,String estado,String fechaF,String fechaV, String sku) {
