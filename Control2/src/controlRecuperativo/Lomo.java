...
public class Lomo extends Carnes {
	String Estado;
	...
	public Lomo(String nombre,int cantidad,String precio,String marca,String estado,String fechaF,String fechaV, String sku) {
